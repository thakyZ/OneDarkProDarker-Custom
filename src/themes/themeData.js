...
exports.default = {
    editorThemes: {
        Ayu: function () { return Promise.resolve().then(function () { return require("./data/ayu"); }); },
        "Dark Modern": function () { return Promise.resolve().then(function () { return require("./data/darkModern"); }); },
        Gnome: function () { return Promise.resolve().then(function () { return require("./data/gnome"); }); },
        "Just Black": function () { return Promise.resolve().then(function () { return require("./data/justBlack"); }); },
        Nord: function () { return Promise.resolve().then(function () { return require("./data/nord"); }); },
        Ocean: function () { return Promise.resolve().then(function () { return require("./data/ocean"); }); },
        "One Dark Pro Darker": function () { return Promise.resolve().then(function () { return require("./data/oneDarkProDarker"); }); },
        "One Dark Pro Darker Custom": function () { return Promise.resolve().then(function () { return require("./data/oneDarkProDarkerCustom"); }); },
        Panda: function () { return Promise.resolve().then(function () { return require("./data/panda"); }); },
        Retro: function () { return Promise.resolve().then(function () { return require("./data/retro"); }); },
        Shadow: function () { return Promise.resolve().then(function () { return require("./data/shadow"); }); },
        Solarized: function () { return Promise.resolve().then(function () { return require("./data/solarized"); }); },
        "Solarized Flat": function () { return Promise.resolve().then(function () { return require("./data/solarizedFlat"); }); },
        Tokyo: function () { return Promise.resolve().then(function () { return require("./data/tokyo"); }); },
        "VS Code": function () { return Promise.resolve().then(function () { return require("./data/vscode"); }); },
    },
    textColors: {
        classic: {
            chalky: "#e5c07b",
